...
public class LayerManager implements IMapLayer {
    ...
    private final LineLayer mLineLayer = null;
    ...
    public Polyline addPolyline(PolylineOptions polylineOptions) {
        ...
        return addPolyline(polylineOptions,layerId);
    }

    public Polyline addPolyline(PolylineOptions polylineOptions,String layerId) {
        ...
        return new Polyline(this, polylineOptions, layerId);
    }

    private Layer updatePolyLineLayer(String layerId, Feature feature, PolylineOptions polylineOptions) {
    ...
    public Polygon addPolygon(PolygonOptions polygonOptions) {
        String layerId = UUID.randomUUID().toString();
        return addPolygon(polygonOptions,layerId);
    }

    public Polygon addPolygon(PolygonOptions polygonOptions,String layerId) {
        ...
        return new Polygon(this, polygonOptions, layerId);
    }

    private void updatePolygonLayer(String layerId, Feature feature, PolygonOptions polygonOptions) {
    ...
    public Circle addCircle(CircleOptions circleOptions) {
        String layerId = UUID.randomUUID().toString();
        return addCircle(circleOptions,layerId);
    }

    public Circle addCircle(CircleOptions circleOptions,@NonNull  String id) {
        ...
        updateCircleLayer(id, feature, circleOptions);
        return new Circle(this, circleOptions, id);
    }

    private void updateCircleLayer(String layerId, Feature feature, CircleOptions circleOptions) {
    ...
    public void updateOption(String layerId, BaseOptions baseOptions) {
        ...
        if (baseOptions instanceof CircleOptions polylineOptions) { // 圆形
            updateCircleLayer(layerId, null, polylineOptions);
        } else if (baseOptions instanceof PolylineOptions polylineOptions) { // 线条
            updatePolyLineLayer(layerId, null, polylineOptions);
        } else if (baseOptions instanceof PolygonOptions polygonOptions) { // 多边形
