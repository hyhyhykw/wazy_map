...
public class CircleOptions extends BaseOptions implements Serializable {
    ...
    public HashMap<String,Object> toArguments(){
        ...
        options.put("radius",(double) radius);
        options.put("fillColor", ColorUtils.intToARGBHex(fillColor));
        options.put("strokeColor", ColorUtils.intToARGBHex(strokeColor));
        options.put("strokeWidth", (double) strokeWidth);
        options.put("center",centerPoint.toArguments());
        options.put("isVisible",isVisible);
        options.put("zIndex",(double)zIndex);
        options.put("isDottedLine",isDottedLine);
        return  options;
    }
