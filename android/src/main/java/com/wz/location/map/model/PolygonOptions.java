...
import com.wz.location.map.util.ColorUtils;
...
public class PolygonOptions extends BaseOptions implements Serializable {
    ...
    public HashMap<String,Object> toArguments(){
        ...
        List< HashMap<String, Object> > pointJsons=new ArrayList<>();
        for (LatLng point : points) {
            pointJsons.add(point.toArguments());
        }
        arguments.put("points",pointJsons);

        arguments.put("strokeWidth",(double) strokeWidth);
        arguments.put("fillColor", ColorUtils.intToARGBHex(fillColor));
        arguments.put("strokeColor", ColorUtils.intToARGBHex(strokeColor));
        arguments.put("zIndex",(double) zIndex);
        arguments.put("isDottedLine", isDottedLine);
        arguments.put("isVisible", isVisible);
        //options
        return arguments;
    }
